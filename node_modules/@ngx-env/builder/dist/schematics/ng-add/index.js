...
function writeBuilder(project, target, builder, mandatory = false, options) {
    ...
    project.architect[target] = Object.assign(Object.assign({}, project.architect[target]), { options: Object.assign(Object.assign({}, project.architect[target].options), options), builder });
}
