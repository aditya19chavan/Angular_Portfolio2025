...
export class Tag {
    ...
    static readonly MYSQL = new Tag('MySQL', '#00758F');  // MySQL color
static readonly NODEJS = new Tag('Node.js', '#339933'); // Node.js color
static readonly EXPRESSJS = new Tag('Express.js', '#000000'); // Express.js color
static readonly MONGODB = new Tag('MongoDB', '#47A248'); //  MongoDB
static readonly AXIOS = new Tag('Axios', '#5A29E4'); //  Added Axios
